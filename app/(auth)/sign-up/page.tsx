...
export default function SignUpPage() {
  ...
  const dbRole =
    ROLE_OPTIONS.find((r) => r.value === selectedRole)?.dbRole ?? "supporter"
      ...
      <form action={action} noValidate className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            maxLength={100}
            aria-describedby={
              getFieldError("displayName") ? "displayName-error" : undefined
            }
        ...
        <div className="flex flex-col gap-1">
          ...
          <p
            id="password-hint"
            className="text-xs font-subhead text-charcoal/50"
          >
