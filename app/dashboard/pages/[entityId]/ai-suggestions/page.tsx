...
function ScoreBadge({ score, maxScore }: { score: number; maxScore: number }) {
  ...
  const label =
    pct >= 80 ? "Strong" : pct >= 50 ? "Good — keep improving" : "Needs work"
...
export default async function AiSuggestionsPage({ params }: Props) {
    ...
    return (
      <div className="max-w-2xl space-y-4">
        ...
        <div className="rounded-xl border border-charcoal/10 bg-white px-8 py-12 text-center">
          ...
          <h2 className="font-headline text-xl text-brand-black mb-2">AI Suggestions is a paid feature</h2>
          <p className="font-body text-sm text-charcoal/60 max-w-sm mx-auto mb-6">
            Upgrade to Standard or Premium to unlock your page optimization score, AI-generated copy suggestions, and SEO recommendations.
          </p>
          <Link
  ...
  const checklist = computePageChecklist(
    { tagline: listing.tagline, meta_title: listing.meta_title, meta_description: listing.meta_description },
    details,
    mediaCount,
    serviceCount,
    hoursCount,
    ...
    <div className="max-w-2xl space-y-6">
        ...
        <div className="rounded-xl border border-charcoal/10 bg-white overflow-hidden">
          {CATEGORY_ORDER.map((cat, catIdx) => {
            ...
            return (
              <div
                key={cat}
                className={catIdx > 0 ? "border-t border-charcoal/5" : undefined}
              >
        ...
        {suggestions.length === 0 ? (
          <div className="rounded-xl border border-charcoal/10 bg-white px-6 py-10 text-center">
            ...
            <p className="font-body text-sm text-charcoal/60">
              AI copy suggestions coming in V2.
            </p>
            <p className="font-body text-xs text-charcoal/40 mt-1">
              Once available, AI-generated suggestions for your description, SEO copy,
              and social captions will appear here — ready for your review and approval
      ...
      <div className="rounded-xl border border-charcoal/10 bg-pale-lavender/20 px-5 py-4">
        ...
        <p className="font-body text-xs text-charcoal/50 leading-relaxed">
          All AI-generated suggestions require your review and approval before anything
          is published to your page. You stay in control — nothing changes without you
