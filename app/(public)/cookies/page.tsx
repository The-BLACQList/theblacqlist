        ...
        <div className="max-w-2xl space-y-10 font-body text-charcoal leading-relaxed">
          ...
          <div className="rounded-xl border border-amber-gold/30 bg-amber-gold/5 px-5 py-4">
            ...
            <p className="font-body text-sm text-charcoal mt-1">
              This page contains placeholder cookie policy content. Have a qualified attorney review and
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              website remember your preferences, keep you signed in, and understand how you use the platform.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-subhead font-semibold text-brand-black mb-2">Essential cookies</h3>
                <p>
                  These cookies are required for the platform to function. They manage your authentication
                  session and keep you signed in between pages. You cannot opt out of essential cookies
                  while using the platform.
                </p>
                <ul className="list-disc list-inside space-y-1 pl-2 mt-2 text-sm">
                  <li><strong>sb-access-token</strong> — Supabase session token (authentication)</li>
                  <li><strong>sb-refresh-token</strong> — Session refresh token</li>
                </ul>
              </div>

              <div>
                <h3 className="font-subhead font-semibold text-brand-black mb-2">Analytics cookies</h3>
                <p>
                  We use Vercel Analytics to understand how users interact with the platform. This data is
                  anonymized and does not include personally identifiable information. Vercel Analytics
                  uses a privacy-preserving approach that does not require traditional cookies.
                </p>
              </div>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              cookies. Note that blocking essential cookies will prevent you from signing in to the platform.
            </p>
            <p>
              For guidance on managing cookies in your browser, visit your browser&apos;s help documentation.
            </p>
          </section>
