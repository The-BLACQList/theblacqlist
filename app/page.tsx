  ...
  return (
    <>
      ...
      <Section variant="white" id="how-it-works">
        <SectionHeading align="center" subtitle="One platform. Every city. All Black-owned.">
          Discover. Support. Connect.
        </SectionHeading>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          {FEATURES.map((card) => (
            <div key={card.title} className="rounded-lg border border-pale-lavender p-6">
              <div className={`w-8 h-8 rounded-md ${card.accent} mb-4`} aria-hidden="true" />
              <h3 className="font-headline text-lg text-brand-black mb-2">{card.title}</h3>
              <p className="font-subhead text-sm text-charcoal leading-relaxed">{card.body}</p>
            </div>
          ))}
        </div>
      </Section>
      ...
      <Section variant="pale-lavender" id="categories">
        <SectionHeading align="center" subtitle="Every industry. Every city.">
          Explore by Category
        </SectionHeading>
      ...
      <Section variant="deep-bg" id="blacqlist-pages">
        <div className="max-w-2xl">
          <SectionHeading onDark subtitle="More than a listing. A living business profile.">
            Your BLACQList Page
          </SectionHeading>
      ...
      <Section variant="deep-bg" id="join">
        <div className="text-center max-w-xl mx-auto">
          ...
          <p className="font-subhead text-pale-lavender text-base md:text-lg mb-8">
            Join the platform built to move money, grow community, and celebrate Black-owned
            excellence — in every city.
          </p>
