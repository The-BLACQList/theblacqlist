        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-pale-lavender flex items-center justify-center">
              <LayoutDashboard className="size-5 text-amber" aria-hidden="true" />
            </div>
          ...
          >
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-pale-lavender flex items-center justify-center">
              <History className="size-5 text-amber" aria-hidden="true" />
            </div>
            <div className="flex-1 min-w-0">
          ...
          >
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-pale-lavender flex items-center justify-center">
              <Sparkles className="size-5 text-amber" aria-hidden="true" />
            </div>
            <div className="flex-1 min-w-0">
          ...
          >
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-pale-lavender flex items-center justify-center">
              <Bookmark className="size-5 text-amber" aria-hidden="true" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="font-subhead text-sm font-semibold text-brand-black">
                Saved businesses
              </p>
              <p className="font-subhead text-xs text-charcoal-soft">Businesses you&apos;ve saved</p>
            </div>
            <ChevronRight className="size-4 text-charcoal-faint shrink-0" aria-hidden="true" />
          </Link>
          ...
          >
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-pale-lavender flex items-center justify-center">
              <FileCheck className="size-5 text-amber" aria-hidden="true" />
            </div>
            <div className="flex-1 min-w-0">
          ...
          >
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-pale-lavender flex items-center justify-center">
              <Receipt className="size-5 text-amber" aria-hidden="true" />
            </div>
            <div className="flex-1 min-w-0">
          ...
          >
            <div className="flex-shrink-0 w-10 h-10 rounded-full bg-pale-lavender flex items-center justify-center">
              <TrendingUp className="size-5 text-amber" aria-hidden="true" />
            </div>
            <div className="flex-1 min-w-0">
