...
export async function POST(request: NextRequest) {
  ...
  if (!listing) {
    return NextResponse.json({ error: "Listing not found or you do not have permission to upload here." }, { status: 403 })
  }
  ...
  if (dbError || !newMedia) {
    ...
    return NextResponse.json({ error: "Failed to save media record. Please try again." }, { status: 500 })
  }
