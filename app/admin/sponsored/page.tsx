      ...
      <table className="w-full text-sm font-body" aria-label="Sponsored placements">
        <thead>
          <tr className="border-b border-charcoal/10 bg-pale-lavender/30 text-left">
            <th className="px-4 py-2.5 font-subhead text-xs font-semibold text-charcoal/50 uppercase tracking-wide">
              Listing
            </th>
            <th className="px-4 py-2.5 font-subhead text-xs font-semibold text-charcoal/50 uppercase tracking-wide">
              City
  ...
  return (
    <div className="max-w-4xl space-y-8">
      ...
      <section aria-labelledby="active-heading">
        <h2
          id="active-heading"
          className="font-subhead text-xs font-semibold text-charcoal/50 uppercase tracking-wide mb-3"
        >
