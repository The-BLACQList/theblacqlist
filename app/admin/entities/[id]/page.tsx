        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="rounded-xl border border-charcoal/10 bg-white p-5">
            ...
            <dl>
              ...
              <Row label="Submitted by" value={submitterProfile?.display_name ?? listing.submitted_by ?? "Unknown"} />
          ...
          <div className="rounded-xl border border-charcoal/10 bg-white p-5">
            ...
            {details ? (
              <dl>
                ...
                <Row label="Location" value={[details.city_text, details.state].filter(Boolean).join(", ") || null} />
                <Row label="Email" value={details.email} />
                <Row label="Phone" value={details.phone} />
                <Row label="Website" value={details.website_url && (
                  <a href={details.website_url} target="_blank" rel="noopener noreferrer" className="text-amber-gold hover:underline truncate block">
                    {details.website_url}
                  </a>
                )} />
