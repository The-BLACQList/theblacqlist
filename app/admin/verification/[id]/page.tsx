...
function Row({ label, value }: { label: string; value: string | null | undefined }) {
  return (
    <div className="flex gap-4 py-3 border-b border-charcoal/5 last:border-0">
      <dt className="w-40 shrink-0 font-subhead text-xs text-charcoal/50 uppercase tracking-wide pt-0.5">
        {label}
      </dt>
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <Link
            ...
            className="font-subhead text-xs text-charcoal/50 hover:text-brand-black mb-2 inline-block"
          >
        ...
        <Link
          ...
          className="shrink-0 font-subhead text-xs text-charcoal/50 hover:text-brand-black"
        >
          Full entity →
        </Link>
      </div>
              ...
              return (
                <li key={path} className="flex items-center gap-3 rounded-lg border border-charcoal/10 px-4 py-2.5">
                  {isPdf ? (
                    ...
                    <ImageIcon className="size-4 shrink-0 text-charcoal/40" aria-hidden="true" />
                  )}
                  <span className="flex-1 min-w-0 font-mono text-xs text-charcoal/70 truncate">
                    {filename}
                  </span>
                  <a
                    href={url}
                    ...
                    className="shrink-0 font-subhead text-xs font-semibold text-amber-gold hover:text-light-gold"
                  >
                    View →
                  </a>
                </li>
