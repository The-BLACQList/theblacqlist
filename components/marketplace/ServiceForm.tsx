...
interface ServiceFormProps {
  action: (
    prev: CreateServiceState | UpdateServiceState | null,
    formData: FormData
  ) => Promise<CreateServiceState | UpdateServiceState>
    ...
    <form action={formAction} className="space-y-5 max-w-xl">
      ...
      <div className="space-y-1">
        ...
        {fieldErrors.booking_url && (
          <p id="booking-error" role="alert" className="font-body text-xs text-red-600">
            {fieldErrors.booking_url}
          </p>
        )}
