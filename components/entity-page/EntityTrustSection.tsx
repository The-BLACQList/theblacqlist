...
const TIER_DESCRIPTIONS: Record<EntityPageData["trust_tier"], string> = {
  ...
  claimed:
    "The owner of this listing has verified their identity and claimed this page.",
  verified:
    "This business has been reviewed and verified by The BLACQList team.",
  certified:
            ...
            {isUnclaimed && (
              <div className="bg-white rounded-xl border border-amber-gold/40 p-4">
                ...
                <p className="font-body text-sm text-charcoal mb-3">
                  Claim this listing to update your information, add photos, and
          ...
          <div className="flex-shrink-0 md:w-48 bg-white rounded-xl border border-charcoal/10 p-4 text-center">
            {entity.avg_rating !== null ? (
              <>
                ...
                <p className="font-subhead text-xs text-charcoal mt-0.5">
                  out of 5
                </p>
