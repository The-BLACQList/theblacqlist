...
const SOCIAL_FIELDS = [
  { id: "s-ig", name: "social_instagram", label: "Instagram", placeholder: "https://instagram.com/yourbusiness" },
  { id: "s-fb", name: "social_facebook", label: "Facebook", placeholder: "https://facebook.com/yourbusiness" },
  { id: "s-li", name: "social_linkedin", label: "LinkedIn", placeholder: "https://linkedin.com/company/yourbusiness" },
  { id: "s-tt", name: "social_tiktok", label: "TikTok", placeholder: "https://tiktok.com/@yourbusiness" },
  { id: "s-yt", name: "social_youtube", label: "YouTube", placeholder: "https://youtube.com/@yourbusiness" },
  { id: "s-tw", name: "social_twitter", label: "X / Twitter", placeholder: "https://x.com/yourbusiness" },
] as const
  ...
  return (
    <div className="rounded-xl border border-charcoal/10 bg-white">
      <div className="px-5 py-4 border-b border-charcoal/8">
        ...
        <p className="font-body text-xs text-charcoal/50 mt-0.5">All URLs must start with https://</p>
      </div>
