  ...
  return (
    <div className="rounded-xl border border-charcoal/10 bg-white">
      ...
      <form action={formAction} className="px-5 py-4 space-y-4">
        ...
        <div>
          <label htmlFor="cta-type" className="block font-subhead text-xs font-semibold text-charcoal/70 mb-1">
        ...
        {requiresUrl && (
          <div>
            <label htmlFor="cta-url" className="block font-subhead text-xs font-semibold text-charcoal/70 mb-1">
        ...
        <div>
          <label htmlFor="cta-label" className="block font-subhead text-xs font-semibold text-charcoal/70 mb-1">
            Button label override <span className="font-normal text-charcoal/40">(optional, max 50 chars)</span>
          </label>
          <input
            id="cta-label"
