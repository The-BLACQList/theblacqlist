    ...
    <div className="rounded-xl border border-charcoal/10 bg-white">
      <div className="px-5 py-4 border-b border-charcoal/8">
        ...
        <p className="font-body text-xs text-charcoal/50 mt-0.5">
          These fields control how your page appears in Google search results. Defaults to your business name and description if left blank.
        </p>
      </div>
      <form action={formAction} className="px-5 py-4 space-y-4">
        ...
        <div>
          <label htmlFor="seo-title" className="block font-subhead text-xs font-semibold text-charcoal/70 mb-1">
          ...
          />
          <p className={`font-body text-xs text-right mt-0.5 ${titleChars > 55 ? "text-amber-gold" : "text-charcoal/40"}`}>
            {titleChars}/60
          </p>
        </div>

        <div>
          <label htmlFor="seo-desc" className="block font-subhead text-xs font-semibold text-charcoal/70 mb-1">
          ...
          />
          <p className={`font-body text-xs text-right mt-0.5 ${descChars > 150 ? "text-amber-gold" : "text-charcoal/40"}`}>
            {descChars}/160
          </p>
        </div>
