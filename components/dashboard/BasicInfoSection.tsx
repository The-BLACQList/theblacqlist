  ...
  return (
    <div className="rounded-xl border border-charcoal/10 bg-white">
      <div className="px-5 py-4 border-b border-charcoal/8">
        ...
        <p className="font-body text-xs text-charcoal/50 mt-0.5">Your business name and tagline appear on your public page.</p>
      </div>
      <form action={formAction} className="px-5 py-4 space-y-4">
        <input type="hidden" name="listing_id" value={listingId} />

        <div>
          <label htmlFor="bi-name" className="block font-subhead text-xs font-semibold text-charcoal/70 mb-1">
        ...
        <div>
          <label htmlFor="bi-tagline" className="block font-subhead text-xs font-semibold text-charcoal/70 mb-1">
            Tagline
          </label>
          <input
            id="bi-tagline"
