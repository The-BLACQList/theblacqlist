...
**Step 2 verdict:** sign-up itself passes. Three P1s found, three fixed in code (#129 `d7e15ea`, #133 `2eac128` + `0d8d5fe`); one founder action outstanding (A-5 → C-3, Resend apex domain).
