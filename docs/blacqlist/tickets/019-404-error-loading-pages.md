...
export default function Error({
  ...
  return (
    <main
      id="main-content"
      className="min-h-screen bg-[#FCFAF4] flex flex-col items-center justify-center px-4 text-center"
    >
      <h1 className="font-headline text-3xl font-bold text-black">Something went wrong.</h1>
      ...
      <Link href="/" className="mt-4 text-[#595758] underline text-sm">
        Return to homepage
      </Link>
    </main>
  )
...
export default function NotFound() {
  return (
    <main
      id="main-content"
      className="min-h-screen bg-[#19191E] flex flex-col items-center justify-center px-4 text-center"
    >
      <p className="font-headline text-8xl md:text-9xl font-bold text-[#E2A428]">404</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-8">
        ...
        <Button
          asChild
          variant="outline"
          className="border-white text-white bg-transparent px-6 py-3 rounded-full hover:bg-white/10"
        >
