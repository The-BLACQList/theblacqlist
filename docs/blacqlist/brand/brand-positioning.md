# Brand Positioning — The BLACQList

**Last updated:** 2026-05-07 (updated from Brand Style Guide .pptx)
...
The BLACQList is the national discovery and commerce platform that makes the Black economy visible, accessible, and self-reinforcing.

---

## Positioning Statement

**For** Black consumers, allies, and community members who want to intentionally support Black-owned businesses, professionals, creatives, and events,

**The BLACQList** is a national discovery and commerce platform

**that** makes it easy to find, trust, and transact with Black-owned entities in every city —

**unlike** a generic business directory or social feed,

**The BLACQList** presents every entity through a polished, purpose-built BLACQList Page that functions like a professional micro-website, with trust signals, community validation, and direct paths to action.
...
The following voice attributes are defined in the official Brand Style Guide.
...
### Color Palette (confirmed from Brand Style Guide)
...
- Never use Amber Gold as body text — it is an accent only
...
- Do not mix more than two typefaces on a single screen
- All three fonts are available via Google Fonts

---

### Logo Usage Rules (confirmed from Brand Style Guide)
...
- Real business owners, real storefronts, real products — always
- Warm lighting, candid professionalism
- Never stock photography
- Black excellence as the default visual register — not as a theme, as a baseline
- Brand imagery should reinforce the music and cultural sensibility of the platform (modern Black excellence with R&B grounding — see Music & Playlists section)

---

### Page Design Direction

- Every BLACQList Page should feel like an editorial feature, not a form printout
- Generous spacing, strong imagery, clear CTAs
- Amber Gold for primary CTAs — not generic blue
- Trust badges and community signals are visible but not dominant
- Dark backgrounds (`#19191E`) are appropriate for hero sections; light surfaces (`#E9E9F7`, `#FCFAF4`) for content areas
...
Use at least one brand-approved category hashtag per post on relevant platforms.

**Category hashtag examples (from Brand Style Guide):**
`#BlackVeganEateries` · `#BlackTechStartups` · `#BlackOwnedBookstores` · `#BlackHairCareBrands` · `#BlackOwnedJewelryDesigners` · `#BlackCraftsmenWorkshops` · `#BlackHolisticWellness` · `#BlackOwnedSkincareBrands` · `#BlackCulturalGalleries`

The full approved hashtag list is in the Brand Style Guide (slides 16–17).

### Music & Brand Playlist

The BLACQList's musical identity is modern Black excellence — R&B sensibility, culturally grounded, energetic and proud.

Reference playlist (from Brand Style Guide): [Black Pride & Power — Spotify](https://open.spotify.com/playlist/4RajV8Som6AAY6nozcOPaK?si=c28e1ca026564c3b)

This playlist is the reference point for event brand activations, video production sound direction, and social content musical tone.

---

## The Name

**BLACQ** is a deliberate spelling choice — not a typo, not a design gimmick. It signals ownership, intentionality, and creative authority over the naming of a platform built for this community.

**The BLACQList** — not "The Black List" (legal and cultural reasons), not "BLACQList.com" in text — always "The BLACQList" in full form. Shortened to "BLACQList" after first mention.

---

## Atlanta Roots

Atlanta is not just a launch market. It is the cultural credibility anchor for the brand. The BLACQList should feel like it comes from a city where Black business, Black culture, and Black ambition have always been central — not peripheral.

The Atlanta rootedness is authentic, not a marketing strategy. Lead with it proudly and without apology.

---

## Assumptions

- The brand voice is established and consistent from day one — no pivoting once public
- "BLACQ" as a spelling choice is a feature, not a bug — commit to it in all brand materials
- Atlanta is the right anchor city for credibility and launch supply
- Premium visual design is a competitive requirement — a mediocre design undermines the brand positioning

---

## Open Questions

1. ~~Should the brand name always include "The"?~~ — **Resolved:** The brand guide uses both "The BLACQList" (full form) and "BLACQList" (short form). Full form on first reference; short form thereafter.
2. ~~Does the brand have a mascot or icon?~~ — **Resolved:** Category icons exist (5 types). No mascot. The "Q" letterform is a distinctive element in the wordmark.
3. ~~What are the brand voice attributes?~~ — **Resolved:** Empowering, Informed, Energetic, Supportive, Progressive. (See Brand Voice section.)
4. Is there a separate B2B voice guide needed for business owner and sponsor communications, or does the primary brand voice apply to all audiences?
5. ~~Pantone 7555C mismatch~~ — **Resolved:** Updated to Pantone 425 C, the closest standard match for `#595758` (warm dark charcoal). Confirm before offset print production.
6. Should the category icon set be expanded beyond the 5 current icons (Products & Services, Professionals, Creatives, Events, Jobs) as additional entity types are added?

---

## Do Not Overbuild Yet

- Do not create a full brand style guide before the visual design direction is validated
- Do not create brand guidelines for sub-products (marketplace, editorial) before the core platform brand is established
- Do not commission photography until the Page template design is finalized (so photography briefing matches the template dimensions)
- Do not trademark or IP-file ancillary brand marks before the core wordmark is protected
