...
interface EntityRejectedEmailProps {
  listingName: string
  reason: string
  siteUrl?: string
}

export function EntityRejectedEmail({
  listingName,
  reason,
  siteUrl = 'https://theblacqlist.com',
}: EntityRejectedEmailProps) {
  return (
    <Html lang="en">
      <Head />
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={eyebrow}>Submission Update</Text>
            <Text style={heading}>
              We were unable to approve your listing for {listingName}.
            </Text>
            <Text style={paragraph}>
              Thank you for submitting to The BLACQList. After reviewing your submission, our
              editorial team was unable to approve it at this time.
            </Text>
            ...
            <Text style={paragraph}>
              ...
              information that may help, please reach out to our support team. We review every
              case individually.
            </Text>
            ...
            <Text style={paragraph}>
              You can also{' '}
              <a href={`${siteUrl}/add-business`} style={link}>
